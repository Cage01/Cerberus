...
#include "Abilities/CerberusGameplayAbility.h"
...
public:
	...
	bool IsActivationGroupBlocked(ECerberusAbilityActivationGroup Group) const;
	void AddAbilityToActivationGroup(ECerberusAbilityActivationGroup Group, UCerberusGameplayAbility* CerberusAbility);
