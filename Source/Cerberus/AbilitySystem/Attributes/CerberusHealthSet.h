...
private:
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_Health, Category="Cerberus|Health", Meta = (AllowPrivateAccess = true))
	...
	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_MaxHealth, Category="Cerberus|Health", Meta = (AllowPrivateAccess = true))
