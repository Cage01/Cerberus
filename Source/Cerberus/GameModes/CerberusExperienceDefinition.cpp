...
UCerberusExperienceDefinition::UCerberusExperienceDefinition()
{
}


#if WITH_EDITOR
EDataValidationResult UCerberusExperienceDefinition::IsDataValid(TArray<FText>& ValidationErrors)
{
...
void UCerberusExperienceDefinition::UpdateAssetBundleData()
{
