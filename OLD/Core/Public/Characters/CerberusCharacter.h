...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category="SkeletalMeshComp")
	...
	TSubclassOf<AWeaponBase> BP_WeaponClass;

	USkeletalMeshSocket const* WeaponSocketMeshR;
	FVector WeaponSocketR;
	FVector WeaponSocketL;
