...
ACerberusCharacter::ACerberusCharacter()
{
	...
	//WeaponSocketR = SkeletalMeshComponent->GetSocketLocation("rWeaponSocket");
	WeaponSocketMeshR = SkeletalMeshComponent->GetSocketByName("rWeaponSocket");
}
...
void ACerberusCharacter::SpawnWeapon()
{
	...
	Weapon = GetWorld()->SpawnActor<AWeaponBase>(WeaponSocketR, CharRotation,SpawnInfo);
	WeaponSocketMeshR->AttachActor(Weapon, SkeletalMeshComponent);
